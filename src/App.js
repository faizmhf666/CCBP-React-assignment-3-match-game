...
// Replace your code here imagesList[Math.floor(Math.random() * 30)].imageUrl,
class App extends Component {
  state = {
    seconds: 60,
    score: 0,
    activeTabId: tabsList[0].tabId,
    selectImageId: imagesList[0].id,
    isGameOn: true,
  }
  ...
  componentDidMount() {
    ...
    this.myTimer = setInterval(this.renderTimerInSeconds, 1000)
  }
  ...
  onThumbnailClick = id => {
    ...
    if (id === selectImageId) {
      this.setState(prevState => ({
        ...
        selectImageId: imagesList[Math.floor(Math.random() * 30)].id,
      }))
    } else {
      this.setState({isGameOn: false})
      clearInterval(this.myTimer)
  ...
  renderImageAndTabItems = () => {
    const {selectImageId, activeTabId} = this.state
    const selectImage = imagesList.find(image => image.id === selectImageId)
      .imageUrl
    const updatedList = imagesList.filter(each => each.category === activeTabId)

    return (
      <div className="game-container">
        <img src={selectImage} alt="match" className="match-image" />
    ...
    return (
      <div className="result-container">
        ...
        <div className="result-data">
          <p>YOUR SCORE</p>
          <p>{score}</p>
          <button type="button" onClick={this.resetGame} className="reset-btn">
            <img
  ...
  render() {
    const {seconds, score, isGameOn} = this.state
      ...
      <div>
        <div className="nav-bar-container">
          <ul className="nav-list-container">
            ...
            <div className="updating-items">
              <li className="nav-list-item score-container">
                <p>Score: {score}</p>
              </li>
              <li className="nav-list-item timer-container">
                <img
        ...
        <div className="bottom-container">
          {isGameOn ? this.renderImageAndTabItems() : this.renderResult()}
        </div>
      </div>
    )
  }
